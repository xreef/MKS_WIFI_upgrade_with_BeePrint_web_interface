...
const char STR_MIME_APPLICATION_KEY_DATA[] PROGMEM = "application/x-www-form-urlencoded";

const char STR_OK[] PROGMEM = "ok";
const char STR_TRUE[] PROGMEM = "true";

const char STR_CONTENT_LENGTH[] PROGMEM = "Content-Length";
const char STR_CONTENT_ENCODING[] PROGMEM = "Content-Encoding";

const char STR_JSON_ERR_0[] PROGMEM = "{\"err\":0}";
const char STR_JSON_ERR_1[] PROGMEM = "{\"err\":1}";
...
const char STR_JSON_ERR_500_IS_UPLOADING_ALREADY[] PROGMEM = "{\"err\":\"ERROR 500: IS UPLOADING ALREADY\"}";
